...
def _main():
    ...
    logging = TensorBoard(log_dir=log_dir)#my_callback()#TensorBoard(log_dir=log_dir)
    logging2 = my_callback()
    ...
    model.fit_generator(data_generator_wrapper(lines[:num_train],im_names[:num_train], batch_size, input_shape, anchors, num_classes),
